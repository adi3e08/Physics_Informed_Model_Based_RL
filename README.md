...
We measure the sensitivity to initial conditions by computing the rate of separation of trajectories which start from nearby initial states, i. e., by computing Lyapunov exponents. The sensitivity to initial conditions depends on factors such as system dynamics, control policy, degree of actuation and damping.
