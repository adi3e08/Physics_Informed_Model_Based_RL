    ...
    def __init__(self, arglist):
        ...
        if self.arglist.mode == "train":
            ...
            if self.arglist.model == "lnn":
                self.transition_model = lnn(self.env.name, self.env.obs_size, self.env.action_size, self.env.dt, self.env.n, self.arglist.batch_size, self.device).to(self.device)
